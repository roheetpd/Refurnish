...
public class ProductServiceImpl implements IProductService{
	...
	public String addProduct(ProductDto input) {
		...
		// Link the category pojo with product pojo by adding it into categories product list
	...
	public ProductDto getProductDetail(Integer pid) {
		...
		return new ProductDto(stock.getCurrentProduct(), stock.getCurrentProduct().getSelectedCategory().getName(), stock);
	}
