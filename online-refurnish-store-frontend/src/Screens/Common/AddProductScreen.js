                        ...
                        <div className="row">
                            ...
                            <div className="col-md-5">
                                <div className="mb-3">
                                    ...
                                    <input onChange={(e)=> setPrice(e.target.value)} type="number" className="NextBtn"  />
                                </div>                            
                                 <div className="mb-3">
                                    <label className="form-label">Unit:  </label>
                                    <input onChange={(e)=> setUnit(e.target.value)} type="text" className="NextBtn" placeholder="pc" value="pc"/>
                                    {
