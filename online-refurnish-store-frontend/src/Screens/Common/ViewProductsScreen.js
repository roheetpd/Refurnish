...
import AddProduct from "C:/Users/shravan/WPT_ALL/CDAC Final Project_Final/online-refurnish-store-frontend/src/Images/AddProduct.jpg"
...
const ViewProductsScreen = (props) => {
    ...
    const url_image = "http://localhost:3000/images"
    const header = {
        headers: {
                                    ...
                                    <div className="card-body text-center">
                                        {
                                            ...
                                            // <img src={} alt="productimage" className="img-fluid productImage"/>
                                            <img src={url_image+`/${detail.product.imageName}`} alt="productimage" className="img-fluid productImage"/>
                                        //    <img src={../../Images/c2.jpg} alt="productimage" className="img-fluid productImage"/>
