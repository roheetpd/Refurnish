    ...
    <div>
      <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark" >
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">Re-furnish</Link>
...

          {
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                <a href="https://forms.zoho.in/refurnish/home#myforms" target="blank" className="nav-link">Customization Requests</a>
                </li>
              ...
              {   
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a href="https://forms.zohopublic.in/refurnish/form/CustomizationDetails/formperma/kuWJYzjt9HD6xEIvheD3GISfJCknQFnbq-fBRDrXzbg" target="blank" className="nav-link">Customize Product</a>
                        </li>
                 </ul>
                 <div className="d-flex">
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/about"> About Us </Link>
                   ...
                   <li className="nav-item">
                    <Link className="nav-link" to="/before-after">Before and Afters</Link>
                </li>   
                <li className="nav-item">
